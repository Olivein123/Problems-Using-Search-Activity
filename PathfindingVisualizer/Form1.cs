...
namespace PathfindingVisualizer
{
    public partial class Form1 : Form
    {
        ...
        Color Cpoc = Color.FromArgb(0,0,255);
        //End node color
        Color Ckraj = Color.FromArgb(111, 205, 11);
        //Wall Color
        Color Czid = Color.FromArgb(0,0,0); 
        Color Cvisited = Color.FromArgb(255, 170, 90);
        Color Cnode = Color.FromArgb(110, 204, 10); 
        Color Cpath = Color.FromArgb(39, 51, 108); 
        Color Cvisited2 = Color.FromArgb(97, 111, 97); 
        Color Cnode2 = Color.FromArgb(150, 49, 49); 
        ...
        void OcistiPlocu(bool Reset)
        {
            ...
            PathLength_label.Text = "Path Length:";
            this.Refresh();
            Nacrtaj();
        ...
        private void Vizualiziraj_button_Click(object sender, EventArgs e)
        {
            ...
            PathLength_label.Text = "Path Length: " + put.Length;
        }
        ...
        private void NoNode_label_Click(object sender, EventArgs e)
        {
